...
import 'package:flutter_twitter_clone/ui/page/allUserOnMapPage/all_user_on_map_page.dart';
import 'package:flutter_twitter_clone/ui/page/confessions_page/confessionsPage.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _getPage(int index) {
    switch (index) {
      ...
      case 2:
        return ConfessionsPage(scaffoldKey: _scaffoldKey);
      case 3:
        return AllUserOnMapPage(scaffoldKey: _scaffoldKey);
      case 4:
